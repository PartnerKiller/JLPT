...
- **Audio Engine**: Web Speech Synthesis API (`window.speechSynthesis`) with optimized asynchronous voice loading, Chrome queue cancellation workaround, and Translate TTS fallback options.
